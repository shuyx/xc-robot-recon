# CLAUDE_MEMORY.md - Claude AI 项目记忆库

**目的**: 为Claude AI助手提供XC-RECON-V2项目的核心记忆和工作指南  
**更新日期**: 2025-07-19  
**项目状态**: Phase 3 前端开发90%完成，API集成待进行
...
### 任务执行模式
1. **📖 首先阅读**: `@docs/README.md` 了解项目架构
2. **🎯 确认背景**: `@docs/technical/xc_os_context.md` 确认项目约束
3. **📈 检查状态**: `@xc_recon_8.md` 了解最新进展
4. **🔍 精确定位**: 根据任务类型查找对应文档和代码
